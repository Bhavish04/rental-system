...
MODEL_PATH = "models/rentsmart_xgb_model.pkl"
SCALER_PATH = "models/rentsmart_scaler.pkl"
ENCODERS_PATH = "models/rentsmart_encoders.pkl"
...
async def get_rent_trend(
    ...
    FIXED:
    - Handles NULL property_type properly
    - Fixes ENUM issue (ACTIVE)
    """
    from sqlalchemy import text

    # 🔥 Build query dynamically (NO NULL ambiguity)
    if property_type:
        query = text("""
            SELECT
